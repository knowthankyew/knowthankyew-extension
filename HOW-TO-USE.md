...
```mermaid
flowchart LR
    Step1["1. Download Zip<br/>& double-click to unpack"] --> Step2["2. Open Browser<br/>Go to chrome://extensions"]
    Step2 --> Step3["3. Turn on Developer Mode<br/>& click 'Load unpacked'"]
    Step3 --> Done["🛡️ Pinned to Toolbar<br/>Ready to protect you"]
```
